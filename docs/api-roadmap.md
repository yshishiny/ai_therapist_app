...
## Phase 2: Assessment administration v2
...
## Design rules
- Every endpoint is org-scoped
- Admin writes emit audit events
- Protected content access is logged before delivery
- Frontend capability rendering must come from backend responses
