    ...
    >
      <div className="max-w-[1080px] mx-auto">
        <div className="flex items-center gap-3.5 mb-11">
          ...
          <div>
            <div className="font-heading text-[1.375rem]">AI Therapist Platform</div>
            <div className="text-[0.8125rem] text-organic-neutral-600">Multi-tenant SaaS for therapists &amp; clinics</div>
          </div>
        </div>

        <h1 className="text-[3.25rem] max-w-[640px] mb-3.5 font-heading leading-[1.1]">Four connected portals, one warm platform.</h1>
        <p className="text-[1.0625rem] text-organic-neutral-700 max-w-[560px] mb-12">
            ...
            >
              <div className="relative">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <span className="text-[0.7812rem] font-semibold tracking-wide uppercase text-organic-neutral-600">{p.layer}</span>
                </div>
                ...
                <div className="flex gap-1.5 flex-wrap mb-5">
                  {p.tags.map((t) => (
                    <span key={t} className="text-[0.7812rem] px-2.5 py-1 rounded-organic-pill bg-organic-neutral-100 text-organic-neutral-700">
                      {t}
                    </span>
                  ))}
                </div>
        ...
        <p className="mt-10 text-[0.8125rem] text-organic-neutral-600">Admin picker · sample data throughout</p>
      </div>
    </div>
  )
}
