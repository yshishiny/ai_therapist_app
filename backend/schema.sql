...
CREATE INDEX IF NOT EXISTS idx_pca_org_clinician ON patient_clinician_assignments (org_id, clinician_id, status);
CREATE INDEX IF NOT EXISTS idx_pca_org_patient ON patient_clinician_assignments (org_id, patient_id, status);
